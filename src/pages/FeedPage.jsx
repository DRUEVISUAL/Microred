...
import SubredditBannerElement from "../components/SubredditBannerElement";
...
const FeedPage = () => {
  ...
  return (
    <main className="absolute right-0 top-14 mx-auto h-full w-full pt-2 xs:px-2 sm:px-4 md:px-8 md:pt-4 lg:top-0 lg:w-[calc(100vw-320px)] lg:px-16 lg:pt-8">
      {/*  */}
